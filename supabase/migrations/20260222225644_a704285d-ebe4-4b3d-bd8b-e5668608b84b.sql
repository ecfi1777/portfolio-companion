...
-- Add color column to screens table
ALTER TABLE public.screens ADD COLUMN color character varying DEFAULT NULL;

-- Now create the RPC function
...
AS $$
  WITH hits AS (
    SELECT DISTINCT
      unnest(sr.matched_symbols) AS symbol,
